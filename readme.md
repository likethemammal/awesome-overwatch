...
- [overwatch-hero-abilities-base](https://github.com/javabird25/overwatch-hero-abilities-base) - This addon lets to have multiple Overwatch Hero Abilities addons to be installed in the same time.
...
- [overwatch-js](https://github.com/gclem/overwatch-js) - Overwatch NodeJS API : Retrieve informations about heroes/players from Overwatch Official Website
